...
\item 
void \mbox{\hyperlink{control_8cpp_a9b800862ae6ceb485c2502aad2fcbaeb}{get\+\_\+var}} ()
\item 
...
Autonomously moving in the environment /param min\+\_\+th defines the threshold distance before that the robot collides with some obstacle 
\begin{DoxyParams}{Parameters}
{\em vel} & defines the linear or angular velocity to publish with respct to where the obstacles are\\
\hline
\end{DoxyParams}
In this function the robot moves in the environment while avoiding obstacles\+: if there is an obstacle in front of, on the right or on the left, the robot turns in such a way to avoid it.\mbox{\Hypertarget{control_8cpp_a9b800862ae6ceb485c2502aad2fcbaeb}\label{control_8cpp_a9b800862ae6ceb485c2502aad2fcbaeb}} 
\index{control.cpp@{control.cpp}!get\_var@{get\_var}}
\index{get\_var@{get\_var}!control.cpp@{control.cpp}}
\doxysubsubsection{\texorpdfstring{get\_var()}{get\_var()}}
{\footnotesize\ttfamily void get\+\_\+var (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})}

Update data passed between nodes 
\begin{DoxyParams}{Parameters}
{\em succ,rej} & and s, re define requests and responses of custom servic about status of the goal \\
\hline
{\em right,center,left} & and ri,c,l define requests and responses of custom servic about minimum distances from obstacles \\
\hline
{\em dir} & and d define requests and responses of custom servic about keyboard commands as user inputs \\
\hline
{\em mod1,mod2} & and m1, m2 define requests and responses of custom servic about which controlling modality to use\\
\hline
\end{DoxyParams}
This function updates all the parameters of the custom service every time it is called.\mbox{\Hypertarget{control_8cpp_a463e9c08d16d29d4ba8c13ab5aef28e0}\label{control_8cpp_a463e9c08d16d29d4ba8c13ab5aef28e0}} 
