...
void get_var(){
/**
* \brief Update data passed between nodes
* \param succ, rej and s, re define requests and responses of custom servic about status of the goal
* \param right, center, left and ri,c,l define requests and responses of custom servic about minimum distances from obstacles
* \param dir and d define requests and responses of custom servic about keyboard commands as user inputs
* \param mod1, mod2 and m1, m2 define requests and responses of custom servic about which controlling modality to use
*
* This function updates all the parameters of the custom service every time it is called.
*/
